...
export const TASK_TYPES = [
  ...
  { id: 'poda', label: 'Poda', icon: Scissors, color: 'text-slate-500', border: 'border-slate-400/30', bg: 'bg-slate-400/10' },
  { id: 'entrenamiento', label: 'Entrenamiento', icon: Activity, color: 'text-slate-500', border: 'border-slate-400/30', bg: 'bg-slate-400/10' },
  { id: 'ambiente', label: 'Cambiar Ambiente', icon: ArrowRightLeft, color: 'text-slate-500', border: 'border-slate-400/30', bg: 'bg-slate-400/10' },
  ...
  { id: 'muerta', label: 'Declarar Muerta', icon: Skull, color: 'text-slate-800', border: 'border-white/30', bg: 'bg-black' },
  { id: 'otro', label: 'Otro', icon: PenTool, color: 'text-slate-500', border: 'border-slate-400/30', bg: 'bg-slate-400/10' },
];
